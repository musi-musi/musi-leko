...
static bool imgui_impl_io_enabled = true;

// Functions
void ImGui_ImpleGlfw_SetIOEnabled(bool enabled) {
    imgui_impl_io_enabled = enabled;
}
...
void ImGui_ImplGlfw_CursorPosCallback(GLFWwindow* window, double x, double y)
{
    ...
    if (imgui_impl_io_enabled) {
        ...
        bd->LastValidMousePos = ImVec2(-1, -1);
    }
}
